export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 flex-shrink-0 fill-greenColegio dark:fill-greenTeam",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-greenColegio dark:fill-neutral-300 dark:hs-tab-active:fill-greenTeam md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:text-greenColegio dark:text-neutral-300 dark:hs-tab-active:text-greenTeam md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 flex-shrink-0 text-greenColegio dark:text-greenTeam",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-greenColegio transition duration-300 group-hover:text-red-400 group-hover:dark:text-greenTeam",
      },
    ],
  ...
  instagramFooter: {
    paths: [
      {
        d: "M12 2.163c3.204 0 3.584.012 4.85.07 1.17.057 1.96.24 2.66.51.73.28 1.36.65 1.98 1.28.62.62 1 1.25 1.28 1.98.27.7.45 1.49.51 2.66.06 1.26.07 1.65.07 4.85s-.012 3.584-.07 4.85c-.057 1.17-.24 1.96-.51 2.66-.28.73-.65 1.36-1.28 1.98-.62.62-1.25 1-1.98 1.28-.7.27-1.49.45-2.66.51-1.26.06-1.65.07-4.85.07s-3.584-.012-4.85-.07c-1.17-.057-1.96-.24-2.66-.51-.73-.28-1.36-.65-1.98-1.28-.62-.62-1-1.25-1.28-1.98-.27-.7-.45-1.49-.51-2.66-.06-1.26-.07-1.65-.07-4.85s.012-3.584.07-4.85c.057-1.17.24-1.96.51-2.66.28-.73.65-1.36 1.28-1.98.62-.62 1.25-1 1.98-1.28.7-.27 1.49-.45 2.66-.51 1.26-.06 1.65-.07 4.85-.07m0-2.163c-3.29 0-3.698.012-4.99.072-1.295.061-2.188.27-2.95.572-.82.321-1.515.75-2.198 1.433-.683.683-1.112 1.378-1.433 2.198-.302.762-.511 1.655-.572 2.95-.061 1.292-.072 1.7-.072 4.99s.012 3.698.072 4.99c.061 1.295.27 2.188.572 2.95.321.82.75 1.515 1.433 2.198.683.683 1.378 1.112 2.198 1.433.762.302 1.655.511 2.95.572 1.292.061 1.7.072 4.99.072s3.698-.012 4.99-.072c1.295-.061 2.188-.27 2.95-.572.82-.321 1.515-.75 2.198-1.433.683-.683 1.112-1.378 1.433-2.198.302-.762.511-1.655.572-2.95.061-1.292.072-1.7.072-4.99s-.012-3.698-.072-4.99c-.061-1.295-.27-2.188-.572-2.95-.321-.82-.75-1.515-1.433-2.198-.683-.683-1.378-1.112-2.198-1.433-.762-.302-1.655-.511-2.95-.572-1.292-.061-1.7-.072-4.99-.072zm0 5.838a6.168 6.168 0 0 0-6.162 6.163 6.168 6.168 0 0 0 6.162 6.162 6.168 6.168 0 0 0 6.162-6.162 6.168 6.168 0 0 0-6.162-6.163zm0 10.25a4.088 4.088 0 0 1-4.088-4.087 4.088 4.088 0 0 1 4.088-4.088 4.088 4.088 0 0 1 4.087 4.088 4.088 4.088 0 0 1-4.087 4.087zm6.406-10.837a1.44 1.44 0 1 0 0-2.88 1.44 1.44 0 0 0 0 2.88z",
        },
      ],
      class: "h-4 w-4 flex-shrink0 fill-current text-neutral-700 dark:text-neutral-400",
      viewBox: "0 0 24 25",
      fill: "currentColor",
      title: "Instagram",
    },
  ...
  quotation: {
    ...
    class:
      "absolute start-0 top-0 h-16 w-16 -translate-x-6 -translate-y-8 transform text-greenColegio dark:text-greenTeam",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
  ...
  question: {
    ...
    class:
      "mt-1.5 h-6 w-6 flex-shrink-0 text-greenColegio dark:text-greenTeam",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
